...
public interface CursoPersonalRepository extends JpaRepository<CursoPersonal, Long>{
	void save(Optional<CursoPersonal> CursoPersonalToUpdate);
	...
	List<CursoPersonal> findAllCursoPersonal(@Param("id") Long id);
